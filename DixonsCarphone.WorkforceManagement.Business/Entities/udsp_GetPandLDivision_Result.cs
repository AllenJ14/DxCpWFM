...
namespace DixonsCarphone.WorkforceManagement.Business.Entities
{
    ...
    public partial class udsp_GetPandLDivision_Result
    {
        public int AccountEntryHeaderId { get; set; }
        public string AccountEntryHeaderText { get; set; }
        public string PeriodYear { get; set; }
        public Nullable<short> PeriodMonth { get; set; }
        public int StoreNumber { get; set; }
        public Nullable<int> ManagerName { get; set; }
        public Nullable<long> AccountEntryDetailId { get; set; }
