...
Param(
  ...
  [string] $TemplateFile = '..\Templates\DixonsCarphoneWorkforceManagementWeb.json',
  [string] $TemplateParametersFile = '..\Templates\DixonsCarphoneWorkforceManagementWeb.param.dev.json',
