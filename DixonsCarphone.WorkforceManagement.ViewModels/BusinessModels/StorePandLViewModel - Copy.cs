...
namespace DixonsCarphone.WorkforceManagement.ViewModels.BusinessModels
{
    public class StorePandLViewModel : BaseViewModel
    {
        ...
        {
            ActualTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1)?.Sum(x => x.ActualTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 5)?.Sum(x => x.ActualTotal),
            BudgetTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1)?.Sum(x => x.BudgetTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 5)?.Sum(x => x.BudgetTotal),
            QtdActualTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1)?.Sum(x => x.QtdActualTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 5)?.Sum(x => x.QtdActualTotal),
            QtdBudgetTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1)?.Sum(x => x.QtdBudgetTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 5)?.Sum(x => x.QtdBudgetTotal),
            YtdActualTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1)?.Sum(x => x.YtdActualTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 5)?.Sum(x => x.YtdActualTotal),
            YtdBudgetTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1)?.Sum(x => x.YtdBudgetTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 5)?.Sum(x => x.YtdBudgetTotal)
        };
        ...
        {
            ActualTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1).Sum(x => x.ActualTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId != 1).Sum(x => x.ActualTotal),
            BudgetTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1).Sum(x => x.BudgetTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId != 1).Sum(x => x.BudgetTotal),
            QtdActualTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1).Sum(x => x.QtdActualTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId != 1).Sum(x => x.QtdActualTotal),
            QtdBudgetTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1).Sum(x => x.QtdBudgetTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId != 1).Sum(x => x.QtdBudgetTotal),
            YtdActualTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1).Sum(x => x.YtdActualTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId != 1).Sum(x => x.YtdActualTotal),
            YtdBudgetTotal = SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId == 1).Sum(x => x.YtdBudgetTotal) - SubTypeSectionTotals.Where(x => x.AccountEntrySubTypeId != 1).Sum(x => x.YtdBudgetTotal)
        };
